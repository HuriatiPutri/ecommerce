...
/**
 * KuesonerSearch represents the model behind the search form of `common\models\entity\Kuesoner`.
 */
class KuesonerSearch extends Kuesoner2
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'jenis_kelamin', 'usia', 'kedudukan_dalam_keluarga', 'status_pernikahan', 'pendidikan_terakhir', 'pekerjaan', 'penghasilan_perbulan'], 'integer'],
    ...
    {
        $query = Kuesoner2::find()->where(['user_id'=>Yii::$app->user->identity->id]);
