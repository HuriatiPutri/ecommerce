...
/* @var $searchModel common\models\search\DetailSearch */
    ...
    <?php 
        ...
        $gridColumns = [
            ...
            [
                ...
                'filter' => ArrayHelper::map(Pesan::find()->orderBy('name')->asArray()->all(), 'id', 'name'), 
            ...
            [
                'attribute' => 'costumer_id',
                'value' => 'costumer.name',
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => ArrayHelper::map(Costumer::find()->orderBy('name')->asArray()->all(), 'id', 'name'), 
                'filterInputOptions'=>['placeholder'=>''],
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear'=>true],
                ],
            ...
            [
                'attribute' => 'pesan_total',
                'format' => 'integer',
                'headerOptions' => ['class' => 'text-right'],
                'contentOptions' => ['class' => 'text-right'],
            ],
            [
                'attribute' => 'pesan_paid',
                'format' => 'integer',
                'headerOptions' => ['class' => 'text-right'],
                'contentOptions' => ['class' => 'text-right'],
            ],
